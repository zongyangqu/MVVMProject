...
public class WeatherNetworkApi extends NetworkApi {
    private static volatile WeatherNetworkApi sInstance;

    public static WeatherNetworkApi getInstance() {
        if (sInstance == null) {
            synchronized (WeatherNetworkApi.class) {
                if (sInstance == null) {
                    sInstance = new WeatherNetworkApi();
                }
            }
        }
        return sInstance;
