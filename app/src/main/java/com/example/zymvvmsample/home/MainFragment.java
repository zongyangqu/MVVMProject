...
import com.example.base.core.autoservice.XiangxueServiceLoader;
...
public class MainFragment extends MvvmFragment<FragmentAppHomeBinding, MvvmBaseViewModel, Fragment> {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        iNewsService = XiangxueServiceLoader.load(INewsService.class);
    ...
    @Override
    public void onListItemInserted(ArrayList<Fragment> sender) {
    }
